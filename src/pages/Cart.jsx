    ...
    <div>
  {
    ...
    (<div className="flex gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
      ...
      <div className="md:w-[30%] w-full flex flex-col gap-8 justify-between">
        ...
        <div className="mt-20">
          <p className="text-xl text-[#141514] uppercase font-[600]">Your Cart</p>
          <p className="text-5xl font-[600] text-[#1c1d1c] uppercase mb-4">Summary</p>
        ...
        <div className="mb-20">
          ...
          <button className="text-lg w-full py-2.5 rounded-lg font-bold text bg-[#fa7102]
          border-2  hover:bg-white hover: border-blue-950 transition-all duration-300 ease-in">
            CheckOut Now
          </button>
        </div>
